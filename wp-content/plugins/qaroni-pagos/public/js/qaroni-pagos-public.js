...
document.addEventListener("DOMContentLoaded", function () {
    var cchname = document.getElementById("qaroni_pagos_cchname");
    var cchnameid = document.getElementById("qaroni_pagos_cchnameid");
    var ccnum = document.getElementById("qaroni_pagos_ccnum");
    var cvv = document.getElementById("qaroni_pagos_cvv");
