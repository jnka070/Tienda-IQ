...
class Instaweb {
	...
	private function define_admin_hooks()
	{
		...
		$plugin_admin = new Instaweb_Admin($this->get_pluginName(), $this->get_version());
	...
	{
		$plugin_public = new Instaweb_Public($this->get_pluginName(), $this->get_version());
