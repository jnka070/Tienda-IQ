...
class Instaweb_Admin
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->pluginName, plugin_dir_url(__FILE__) . 'css/instaweb-admin.css', array(), $this->version, 'all');
    }
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_script($this->pluginName, plugin_dir_url(__FILE__) . 'js/instaweb-admin.js', array('jquery'), $this->version, false);
    }
    /**
    ...
    public function add_instaweb_settings_page()
    {
        add_menu_page(
            ...
            [$this, 'show_instaweb_settings_page'], // Función para mostrar la página
